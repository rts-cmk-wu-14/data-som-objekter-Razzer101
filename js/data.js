...
let footer = {
  ...
  subHeadline: "When Passion Meets Comfort.",
  section: [
    {
      sectionName: "Discover the Network",
      sectionList: [
        {
          name: "Where to shop",
          url: "#"
    ...
    },
    {
      ...
      sectionList: [
        ...
        {
          name: "Reliability and Sequrity",
          url: "#"
        },
      ],
    },
  ],
  copyright: "EazyCammper. All rights reserved.",
  bottomList: [
    {
      name: "About",
      url: "link"
